...
int main() {
  ...
  readInitialData("/Users/claudio/Desktop/School/CS/LMC/COMSC165_AdvancedProgrammingWithC++/Assignments/Assignment8_part2_binaryFileOperation/initial_inventory.txt");
...
void readInitialData(string fileName) {
  ...
  if (inputFile.is_open() && inventoryFile.is_open()) { // If opening is okay
      cout << "Yes";
